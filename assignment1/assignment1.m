...
helpURL = web('http://www.mathworks.com/help/matlab/');


% 2. What does the command 'clear all' do?
%
% Answer: clears the assigned variables and any commands previously
% executed
%
...
%
% Answer: while loop and for loop. The while loop will continue to run the
% loop as long as the condition is true. For loops run a specific number of
% times as specified in the statement.
% 
...
%
% Answer: NaN stands for Not a Number. This would happen if MATLAB
% encountered anything other than a number when the function was only 
% expecting a number or the answer is imaginary.
...
% File exchange in mathworks, download the .zip file to working directory

% Command: Minesweeper
% Warning: The DrawMode property will be removed in a future release. Use the
% SortMethod property instead. 
% > In Minesweeper/CreateGUI (line 1811)
% In Minesweeper/InitializeGUI (line 1446)
% In Minesweeper (line 237)
